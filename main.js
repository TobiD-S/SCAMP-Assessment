...
// I didn't really understand the wording of the question, so I decided to write the two interpretations of the question that I thought of.

// A function fibonacciNum to return the nth number of the sequence
let fibonacciNum = (n) => {
    let x = 0,
        y = 1,
        z = 1;
